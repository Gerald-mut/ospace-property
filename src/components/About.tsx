        ...
        <div className="flex flex-col lg:flex-row items-center gap-16 md:gap-24">
          ...
          >
            ...
            <h2 className="text-brand-navy font-serif text-4xl md:text-5xl mb-8 leading-tight">
              Setting the Standard for Premium Estate Care in Kenya
            </h2>
            <p className="text-gray-600 font-sans font-light text-lg mb-8 leading-relaxed">
              Founded on the belief that property management should be as sophisticated as the architecture it protects. Ospace has grown from a specialized landscaping boutique into a full-cycle estate management firm.
            </p>
            <p className="text-gray-600 font-sans font-light text-lg mb-12 leading-relaxed">
              We serve a limited number of high-profile clients to ensure that every square inch of their property receives our signature "white glove" attention. From meticulous financial reporting to architectural-grade gardening, we are the silent partners in your property's enduring legacy.
            </p>
